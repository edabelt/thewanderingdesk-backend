...
export const apiRoutes = [
  ...
  {
    method: "POST",
    path: "/api/categories/{id}/placemarks",
    config: placemarkApi.create
  },

  {
    method: "PUT",
    path: "/api/placemarks/{id}",
    config: placemarkApi.update
  },
